  ...
  class Api < Grape::API
    ...
    resource :students do
      ...
      get do
        ...
        return ActiveModelSerializers::SerializableResource.new(students: Student.all)
      end
      ...
      get ':id' do
        student = Student.find_by(id: params[:id])
       return ActiveModelSerializers::SerializableResource.new(student: student) if student
